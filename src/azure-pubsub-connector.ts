...
import { AzurePubSubChannel } from './channel/azure-pubsub-channel';
 ...
 */
     ...
     */
     listen(name: string, event: string, callback: Function): AzurePubSubChannel {
        console.log('listen');
    }
     ...
     */
     channel(name: string): AzurePubSubChannel{
        console.log('channel');
    }
